    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            .AddAzureTableStores<ApplicationDbContext>(new Func<IdentityConfiguration>(() =>
            {
                ...
                idconfig.LocationMode = Configuration.GetSection("IdentityAzureTable:IdentityCofiguration:LocationMode").Value;
                return idconfig;
            }))
        ...
        public async void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory,
            IIdentitySeed storageSeed, IMasterDataCacheOperations masterDataCacheOperations, 
            ILogDataOperations logDataOperations,
            INavigationCacheOperations navigationCacheOperations,
            IUnitOfWork unitOfWork)
        {
            loggerFactory.AddConsole();
            // Configure Azure Logger to log all events except the onew that are generated by default by ASP.NET Core.
